...
$BIN_DIR/design_community -s $TEST_DIR/data/input/testTwoSourceTwoSinkSharedIntermediate.edges 01,02 04,05  > testTwoSourceTwoSinkSharedIntermediate.species
