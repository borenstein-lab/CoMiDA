...
$BIN_DIR/write_design_problem $TEST_DIR/data/input/testIgnoreLengthTwoHyperCycleMissingOneSubstrate.edges > testIgnoreLengthTwoHyperCycleMissingOneSubstrate.out
