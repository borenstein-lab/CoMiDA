...
$BIN_DIR/write_design_problem -s $TEST_DIR/data/input/testTwoSourceTwoSinkSeparatePathsSimple.edges 01,02 03,04 > testTwoSourceTwoSinkSeparatePathsSimple.out
