...
$BIN_DIR/write_design_problem -s $TEST_DIR/data/input/testTwoSourceOneSinkOneOptimalPathSimple.edges 01,02 05 > testTwoSourceOneSinkOneOptimalPathSimple.out
